...
-- ============================================================
-- NOTE (BR-38 — Data Integrity):
-- attendance, payroll, shift_assignment, audit_log KHÔNG được hard-delete.
-- Áp dụng soft-delete bằng cột deleted_at (nullable) ở tầng ứng dụng/migration
-- sau nếu cần, thay vì DELETE FROM trực tiếp trong Service layer.
-- ============================================================
