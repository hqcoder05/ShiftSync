...
$shift1Body = @{ shiftDate = "2026-09-12"; startTime = "08:00:00"; endTime = "12:00:00" } | ConvertTo-Json
...
$publishBody = @{ startDate = "2026-09-12"; endDate = "2026-09-12" } | ConvertTo-Json
...
try {
    ...
    Invoke-RestMethod -Uri "http://localhost:8080/api/stores/$storeId/shifts/$($shift1.id)/assignments" -Method Post -Headers @{Authorization="Bearer $managerToken"} -Body $assignBody -ContentType "application/json"
} catch {
