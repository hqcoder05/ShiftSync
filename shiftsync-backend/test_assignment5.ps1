...
# 5. Generate Payroll to create period for 2027-07
$genBody = @{ startDate = "2027-07-01"; endDate = "2027-07-15" } | ConvertTo-Json
...
$periodId = ($periods | Where-Object { $_.startDate -eq "2027-07-01" }).id
