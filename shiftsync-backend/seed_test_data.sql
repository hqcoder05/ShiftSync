...
-- LUU Ý: Ch?y file này sau khi dã ch?y xong toàn b? Flyway migrations.
...
INSERT INTO employment (id, user_id, store_id, employment_type, status, hire_date, max_weekly_hours, created_at, updated_at)
VALUES ('55555555-5555-5555-5555-555555555555', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'FULL_TIME', 'ACTIVE', '2023-01-01', 40, NOW(), NOW());

INSERT INTO employment (id, user_id, store_id, employment_type, status, hire_date, max_weekly_hours, created_at, updated_at)
VALUES ('66666666-6666-6666-6666-666666666666', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'FULL_TIME', 'SUSPENDED', '2023-01-01', 40, NOW(), NOW());

-- 5. T?o Skill
INSERT INTO skill (id, name, category, created_at, updated_at)
VALUES ('77777777-7777-7777-7777-777777777777', 'Cashier', 'ROLE', NOW(), NOW());

-- 6. T?o Shift (Gi? s? vào m?t ngày Th? 2, ví d? 2026-08-24)
