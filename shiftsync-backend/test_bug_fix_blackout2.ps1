...
Write-Output "
--- 1. Insert Manual Blackout Date on Monday ---"
docker exec shiftsync-db psql -U postgres -d shiftsync -c "INSERT INTO blackout_date (id, staff_id, date, reason) VALUES (gen_random_uuid(), 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2026-09-07', 'Manual Blackout Monday') ON CONFLICT DO NOTHING;"

Write-Output "
--- 2. Create and Publish Shift ---"
$shiftBody = '{"shiftDate":"2026-09-07","startTime":"10:00:00","endTime":"14:00:00"}'
...
$publishBody = '{"startDate":"2026-09-07","endDate":"2026-09-07"}'
