...
public class Scenario3Benchmark {
    private static final Logger log = LoggerFactory.getLogger(Scenario3Benchmark.class);

    public static void main(String[] args) {
        // Tat log INFO trong AutoScheduleService de tranh stdout bottleneck khi lap 500 slots
        try {
            LoggerContext lc = (LoggerContext) LoggerFactory.getILoggerFactory();
            lc.getLogger(AutoScheduleService.class).setLevel(Level.WARN);
            lc.getLogger(CpSatAutoScheduleService.class).setLevel(Level.INFO);
        ...
        System.out.println("1. Dang chay Greedy+MRV+Repair (200 NV / 500 Slots)...");
        ...
        System.out.println("-> Greedy hoan thanh trong " + runtimeG + " ms. Gán được: " + assignments.size() + "/" + totalSlots);

        System.out.println("2. Dang chay CP-SAT solver (200 NV / 500 Slots, timeout 10s)...");
        ...
        System.out.println("\n=== KET QUA QUY MO LON (200 NV / 500 SLOTS) ===");
