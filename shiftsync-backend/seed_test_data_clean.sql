...
-- 3. T?o 2 Staff (S?a thnh bcrypt valid hash ho?c dummy, DB khng validate ? t?ng SQL)
...
VALUES ('55555555-5555-5555-5555-555555555555', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', (SELECT id FROM contract_type WHERE name='FULL_TIME' LIMIT 1), 20.0, 'ACTIVE', '2023-01-01');

INSERT INTO employment (id, staff_id, store_id, contract_type_id, hourly_rate, status, joined_date)
VALUES ('66666666-6666-6666-6666-666666666666', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', (SELECT id FROM contract_type WHERE name='FULL_TIME' LIMIT 1), 20.0, 'SUSPENDED', '2023-01-01');
...
-- 6. T?o Shift (Gi? s? 2026-08-24 l Th? 2)
...
-- 8. T?o Availability cho Staff 1 (Th? 2 = 1 trong Java, nhung trong Availability dang dng convention c th? l 1=Monday)
