...
| **EMP25** | `10000000-0000-0000-0000-000000000025` | `emp25@shiftsync.com` | **APPROVED LEAVE (W39):** Đã có đơn nghỉ phép được duyệt ngày `22/09/2026 - 23/09/2026` (Thứ 3 & Thứ 4 tuần W39). AutoScheduler tuyệt đối không xếp ca vào 2 ngày này. | `QA-SCHED-004`<br>`QA-LEAVE-003` |
| **EMP26** | `10000000-0000-0000-0000-000000000026` | `emp26@shiftsync.com` | **SINGLE SKILL (Cashier Only):** Chỉ có duy nhất kỹ năng Thu ngân. AutoScheduler chỉ được xếp vào vị trí Cashier, không gán Barista hay Waiter. | `QA-SCHED-003` |
| **EMP27** | `10000000-0000-0000-0000-000000000027` | `emp27@shiftsync.com` | **SINGLE SKILL (Barista Only):** Chỉ có duy nhất kỹ năng Pha chế. AutoScheduler chỉ được xếp vào vị trí Barista. | `QA-SCHED-003` |
| **EMP28** | `10000000-0000-0000-0000-000000000028` | `emp28@shiftsync.com` | **SINGLE SKILL (Waiter Only):** Chỉ có duy nhất kỹ năng Phục vụ. AutoScheduler chỉ được xếp vào vị trí Waiter. | `QA-SCHED-003` |
| **EMP29** | `10000000-0000-0000-0000-000000000029` | `emp29@shiftsync.com` | **PART-TIME (Max 25h):** Hợp đồng Bán thời gian tối đa 25h/tuần. AutoScheduler kiểm soát không xếp vượt 25 giờ trong tuần W39. | `QA-STAFF-003`<br>`QA-SCHED-006` |
| **EMP30** | `10000000-0000-0000-0000-000000000030` | `emp30@shiftsync.com` | **ZERO-AVAILABILITY:** Hoàn toàn không đăng ký khung giờ rảnh nào. AutoScheduler tuyệt đối không xếp bất kỳ ca nào. | `QA-EMPTY-001`<br>`QA-SCHED-002` |
| **EMP31** | `10000000-0000-0000-0000-000000000031` | `emp31@shiftsync.com` | **BLACKOUT DATE (W39):** Có ngày chặn làm việc vào Thứ Sáu `2026-09-25`. AutoScheduler không xếp ca vào ngày này. | `QA-SCHED-004` |
